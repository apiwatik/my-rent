  ...
  return (
    <html lang="en" className="h-full antialiased">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Material+Symbols+Outlined:wght,FILL,GRAD,opsz@100..700,0..1,-50..200,24&display=block"
          rel="stylesheet"
        />
      </head>
